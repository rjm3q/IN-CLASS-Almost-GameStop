...
const viewBook = (obj) => {
  ...
  <div class="mt-5 d-flex flex-wrap">
   ...
   <div class="text-white ms-5 details">
     <h5>${obj.title} by ${obj.authorObject.studio_name} ${obj.authorObject.publisher_name} ${obj.authorObject.favorite ? '<span class="badge bg-danger"><i class="fa fa-heart" aria-hidden="true"></i></span>' : ''}</h5>
